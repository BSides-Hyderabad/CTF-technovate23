  ...
  return {
    ...
    plugins: [
      ...
      new WebpackShellPlugin({
        onBuildEnd: [
          mode == "development"
            ? "echo Skipping JS stub generation"
            ...
            },
            {
              ...
              options: {
                multiple: [
                  ...
                  {
                    search: "font-faces*{s*font-family:s*[\"']Lato[\"']",
                    replace: "font-face{font-family:'LatoOffline'",
                    flags: "gm",
                  },
                  {
                    search: "font-faces*{s*font-family:s*[\"']Raleway[\"']",
                    replace: "font-face{font-family:'RalewayOffline'",
                    flags: "gm",
                  },
                  // Replace Font-Awesome font-faces
                  {
                    search:
                      "font-faces*{s*font-family:s*[\"']Font Awesome 5 Free[\"']",
                    replace:
                      "font-face{font-family:'Font Awesome 5 Free Offline'",
                    flags: "gm",
                  },
                  {
                    search:
                      "font-faces*{s*font-family:s*[\"']Font Awesome 5 Brands[\"']",
                    replace:
                      "font-face{font-family:'Font Awesome 5 Brands Offline'",
                    flags: "gm",
                  },
                  // Replace Font-Awesome class rules
                  {
                    search:
                      "fars*{s*font-family:s*[\"']Font Awesome 5 Free[\"']",
                    replace:
                      "far{font-family:'Font Awesome 5 Free','Font Awesome 5 Free Offline'",
                    flags: "gm",
                  },
                  {
                    search:
                      "fass*{s*font-family:s*[\"']Font Awesome 5 Free[\"']",
                    replace:
                      "fas{font-family:'Font Awesome 5 Free','Font Awesome 5 Free Offline'",
                    flags: "gm",
                  },
                  {
                    search:
                      "fabs*{s*font-family:s*[\"']Font Awesome 5 Brands[\"']",
                    replace:
                      "fab{font-family:'Font Awesome 5 Brands','Font Awesome 5 Brands Offline'",
                    flags: "gm",
                  },
                ],
                strict: true,
